        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
              Gestion de <span className="text-blue-600">Devis</span> et{" "}
              <span className="text-blue-600">Facturation</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Simplifiez votre processus de facturation avec notre solution
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-xl p-8 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Créez des devis professionnels en quelques clics avec notre
                interface intuitive.
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-8 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Gérez facilement vos clients et leurs informations pour un suivi
                optimal.
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-8 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Transformez vos devis acceptés en factures automatiquement et
            ...
            <div className="bg-gray-50 rounded-xl p-8 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Exportez vos devis et factures en PDF pour un envoi
            ...
            <div className="bg-gray-50 rounded-xl p-8 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Chaque utilisateur dispose de son propre espace sécurisé pour
                gérer ses données.
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-8 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Suivez l&apos;état de vos devis et factures en temps réel avec
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-blue-100">Gérez tous vos devis</p>
              </Link>
              ...
              >
                ...
                <p className="text-blue-100">Suivez vos factures</p>
              </Link>
              ...
              >
                ...
                <p className="text-blue-100">Créez un nouveau devis</p>
              </Link>
            </div>
          </div>
        </section>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 max-w-md">
                Solution moderne de gestion de devis et facturation pour les
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>
              &copy; {new Date().getFullYear()} Invoice & Quote - Développé avec
              ❤️{" "}
            </p>
          </div>
        </div>
