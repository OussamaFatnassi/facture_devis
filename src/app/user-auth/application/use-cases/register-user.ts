...
import { SignupService, SignupRequest, SignupResponse } from '../services/signup-service';
...
export class RegisterUserUseCase {
  ...
  async execute(request: RegisterUserRequest): Promise<RegisterUserResponse> {
    try {
      ...
      const signupResponse: SignupResponse = await this.signupService.signup(signupRequest);
