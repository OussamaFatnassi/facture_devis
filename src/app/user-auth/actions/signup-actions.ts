...
import { RegisterUserUseCase, RegisterUserRequest, RegisterUserResponse } from '../application/use-cases/register-user';
...
export async function registerUser(formData: FormData): Promise<RegisterUserResponse> {
  try {
    // Extract form data
