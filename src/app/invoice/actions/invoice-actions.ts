...
export async function updateInvoiceStatus(formData: FormData) {
  try {
    ...
    throw new Error(error instanceof Error ? error.message : 'Failed to update invoice status');
  }
}
...
export async function getAcceptedQuotations() {
  try {
    ...
    throw new Error(error instanceof Error ? error.message : 'Failed to fetch accepted quotations');
  }
}
